...
// import 'dart:convert';
// import 'package:sarahhhh/theme.dart';
...
//       Uri.parse(ip + '/sanad/employee-info?id=$id'),
//     );
...
//         itemBuilder:
//         (context, index) {
//           String vacations = vacation[index];
...
//                                   fontSize: 15)),
//                           SizedBox(width: 30),
//                           Text(" عـدد الإجـازات الـتـي تـم تـرحـيـلـهـا  ",
//                               style: TextStyle(
//                                   fontFamily: 'myfont',
//                                   fontWeight: FontWeight.bold,
//                                   fontSize: 15)),
...
//                                   fontSize: 15)),
//                           SizedBox(width: 65),
//                           Text(" عـدد الإجـازات الـمـتـبـقـيـة  ",
//                               style: TextStyle(
//                                   fontFamily: 'myfont',
//                                   fontWeight: FontWeight.bold,
//                                   fontSize: 15)),
